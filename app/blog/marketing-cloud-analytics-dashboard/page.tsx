...
export const metadata: Metadata = {
  title: "Marketing Cloud Analytics Dashboard",
  description: "Build comprehensive analytics dashboards to measure Marketing Cloud performance and ROI.",
  keywords: ["Analytics", "Dashboard", "ROI", "Performance", "Reporting"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Marketing Cloud Analytics Dashboard",
    description: "Build comprehensive analytics dashboards to measure Marketing Cloud performance and ROI.",
    type: "article",
    publishedTime: "2024-08-28",
  },
  twitter: {
    card: "summary",
    title: "Marketing Cloud Analytics Dashboard",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/marketing-cloud-analytics-dashboard.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-08-28</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Marketing Cloud Analytics Dashboard
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Build comprehensive analytics dashboards to measure Marketing Cloud performance and ROI.
          </p>
        </header>
