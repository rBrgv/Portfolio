...
export const metadata: Metadata = {
  ...
  description: "Explore proven Marketing Cloud architecture patterns that scale with your business and support complex marketing requirements.",
  keywords: ["Architecture", "Marketing Cloud", "Patterns", "Scalability", "Design"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/marketing-cloud-architecture-patterns.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-04-18</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Marketing Cloud Architecture Patterns
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Explore proven Marketing Cloud architecture patterns that scale with your business and support complex marketing requirements.
          </p>
        </header>
