...
export const metadata: Metadata = {
  ...
  description: "Create integrated marketing journeys for manufacturing companies that align CRM, ERP, and Marketing Cloud for seamless customer experiences.",
  keywords: ["Manufacturing", "CRM", "ERP", "Integration", "Marketing Cloud", "Journeys"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Manufacturing Journeys: Aligning CRM, ERP, and Marketing",
    description: "Create integrated marketing journeys for manufacturing companies that align CRM, ERP, and Marketing Cloud for seamless customer experiences.",
    type: "article",
    publishedTime: "2024-05-02",
  },
  twitter: {
    card: "summary",
    title: "Manufacturing Journeys: Aligning CRM, ERP, and Marketing",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/manufacturing-journeys-aligning-crm-erp-and-marketing.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-05-02</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Create integrated marketing journeys for manufacturing companies that align CRM, ERP, and Marketing Cloud for seamless customer experiences.
          </p>
        </header>
