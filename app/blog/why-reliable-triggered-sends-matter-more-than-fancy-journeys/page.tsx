...
export const metadata: Metadata = {
  ...
  description: "Focus on building reliable, well-tested triggered sends rather than complex journeys that may fail when you need them most.",
  keywords: ["Reliability", "Triggered Sends", "Testing", "Quality", "Best Practices"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/why-reliable-triggered-sends-matter-more-than-fancy-journeys.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2023-11-16</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Focus on building reliable, well-tested triggered sends rather than complex journeys that may fail when you need them most.
          </p>
        </header>
