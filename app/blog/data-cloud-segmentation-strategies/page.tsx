...
export const metadata: Metadata = {
  ...
  description: "Build powerful segmentation strategies in Data Cloud to create targeted, personalized experiences that drive engagement and conversion.",
  keywords: ["Data Cloud", "Segmentation", "Personalization", "Targeting", "Strategy"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Data Cloud Segmentation Strategies",
    description: "Build powerful segmentation strategies in Data Cloud to create targeted, personalized experiences that drive engagement and conversion.",
    type: "article",
    publishedTime: "2024-09-19",
  },
  twitter: {
    card: "summary",
    title: "Data Cloud Segmentation Strategies",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/data-cloud-segmentation-strategies.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-09-19</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Data Cloud Segmentation Strategies
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Build powerful segmentation strategies in Data Cloud to create targeted, personalized experiences that drive engagement and conversion.
          </p>
        </header>
