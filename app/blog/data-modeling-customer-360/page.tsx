...
export const metadata: Metadata = {
  ...
  description: "Design effective data models in Data Cloud to create a comprehensive Customer 360 view that powers personalized experiences.",
  keywords: ["Data Modeling", "Customer 360", "Data Cloud", "Architecture", "Design"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Data Modeling for Customer 360",
    description: "Design effective data models in Data Cloud to create a comprehensive Customer 360 view that powers personalized experiences.",
    type: "article",
    publishedTime: "2024-09-05",
  },
  twitter: {
    card: "summary",
    title: "Data Modeling for Customer 360",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/data-modeling-customer-360.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-09-05</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Data Modeling for Customer 360
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Design effective data models in Data Cloud to create a comprehensive Customer 360 view that powers personalized experiences.
          </p>
        </header>
