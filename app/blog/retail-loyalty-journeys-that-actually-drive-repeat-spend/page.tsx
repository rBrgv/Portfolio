...
export const metadata: Metadata = {
  ...
  description: "Design loyalty programs and journeys that genuinely increase customer lifetime value and drive repeat purchases.",
  keywords: ["Loyalty", "Retail", "Customer Lifetime Value", "Repeat Purchase", "Journeys"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Retail Loyalty Journeys That Actually Drive Repeat Spend",
    description: "Design loyalty programs and journeys that genuinely increase customer lifetime value and drive repeat purchases.",
    type: "article",
    publishedTime: "2024-03-07",
  },
  twitter: {
    card: "summary",
    title: "Retail Loyalty Journeys That Actually Drive Repeat Spend",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/retail-loyalty-journeys-that-actually-drive-repeat-spend.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-03-07</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Design loyalty programs and journeys that genuinely increase customer lifetime value and drive repeat purchases.
          </p>
        </header>
