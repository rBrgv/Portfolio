...
export const metadata: Metadata = {
  ...
  description: "Identify and eliminate the hidden costs of manual lead routing by implementing automated lead scoring and routing in Marketing Cloud.",
  keywords: ["Lead Routing", "Automation", "Lead Scoring", "Efficiency", "Cost Reduction"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/the-hidden-costs-of-manual-lead-routing-and-how-to-fix-it.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-01-25</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Identify and eliminate the hidden costs of manual lead routing by implementing automated lead scoring and routing in Marketing Cloud.
          </p>
        </header>
