...
export const metadata: Metadata = {
  ...
  description: "Learn how to activate Data Cloud segments effectively to drive revenue growth and customer engagement.",
  keywords: ["Data Cloud", "Segmentation", "Revenue", "Activation", "Customer Engagement"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/data-cloud-activation-turning-segments-into-revenue.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-12-04</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Learn how to activate Data Cloud segments effectively to drive revenue growth and customer engagement.
          </p>
        </header>
