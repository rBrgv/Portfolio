...
export const metadata: Metadata = {
  ...
  description: "Discover the three most effective patterns for integrating ERP systems with Marketing Cloud to streamline data flow and improve efficiency.",
  keywords: ["ERP", "Integrations", "Marketing Cloud", "Data Flow", "Efficiency"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/erp-marketing-cloud-integrations-top-3-patterns.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-08-22</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Discover the three most effective patterns for integrating ERP systems with Marketing Cloud to streamline data flow and improve efficiency.
          </p>
        </header>
