...
export const metadata: Metadata = {
  ...
  description: "Reflecting on key learnings from 27 Marketing Cloud journey implementations across different industries and use cases.",
  keywords: ["Marketing Cloud", "Journey Builder", "Lessons Learned", "Production", "Best Practices"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/2024-year-end-lessons-from-27-journeys-in-production.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-12-31</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Reflecting on key learnings from 27 Marketing Cloud journey implementations across different industries and use cases.
          </p>
        </header>
