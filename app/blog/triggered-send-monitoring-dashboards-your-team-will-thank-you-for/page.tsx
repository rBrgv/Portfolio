...
export const metadata: Metadata = {
  ...
  description: "Build comprehensive monitoring dashboards for triggered sends that help your team identify and resolve issues quickly.",
  keywords: ["Monitoring", "Dashboards", "Triggered Sends", "Troubleshooting", "Team Productivity"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/triggered-send-monitoring-dashboards-your-team-will-thank-you-for.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2023-12-28</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Build comprehensive monitoring dashboards for triggered sends that help your team identify and resolve issues quickly.
          </p>
        </header>
