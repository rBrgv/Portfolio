...
export const metadata: Metadata = {
  ...
  description: "Create seamless web-to-CRM lead handoffs that sales teams actually want to use, improving conversion rates and team satisfaction.",
  keywords: ["Lead Handoff", "CRM", "Sales", "Conversion", "User Experience"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Web-to-CRM: Lightweight Handoff That Sales Teams Won't Hate",
    description: "Create seamless web-to-CRM lead handoffs that sales teams actually want to use, improving conversion rates and team satisfaction.",
    type: "article",
    publishedTime: "2023-12-14",
  },
  twitter: {
    card: "summary",
    title: "Web-to-CRM: Lightweight Handoff That Sales Teams Won't Hate",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/web-to-crm-lightweight-handoff-that-sales-teams-wont-hate.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2023-12-14</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Web-to-CRM: Lightweight Handoff That Sales Teams Won't Hate
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Create seamless web-to-CRM lead handoffs that sales teams actually want to use, improving conversion rates and team satisfaction.
          </p>
        </header>
