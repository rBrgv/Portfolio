...
export const metadata: Metadata = {
  ...
  description: "Take your AMPscript skills to the next level with these advanced techniques and patterns.",
  keywords: ["AMPscript", "Technical", "Advanced", "Email Marketing", "Personalization"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/ampscript-advanced-techniques.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-10-09</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            AMPscript Advanced Techniques
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Take your AMPscript skills to the next level with these advanced techniques and patterns.
          </p>
        </header>
