...
export const metadata: Metadata = {
  title: "Marketing Cloud Holiday Campaigns",
  description: "Plan and execute successful holiday campaigns using Marketing Cloud best practices.",
  keywords: ["Holiday Campaigns", "Marketing Cloud", "Seasonal", "Campaign Planning"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/marketing-cloud-holiday-campaigns.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-09-11</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Marketing Cloud Holiday Campaigns
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Plan and execute successful holiday campaigns using Marketing Cloud best practices.
          </p>
        </header>
