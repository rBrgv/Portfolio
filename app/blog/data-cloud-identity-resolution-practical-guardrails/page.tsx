...
export const metadata: Metadata = {
  ...
  description: "Implement effective identity resolution in Data Cloud with practical guardrails and best practices for data quality and privacy.",
  keywords: ["Data Cloud", "Identity Resolution", "Data Quality", "Privacy", "Best Practices"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Data Cloud Identity Resolution: Practical Guardrails",
    description: "Implement effective identity resolution in Data Cloud with practical guardrails and best practices for data quality and privacy.",
    type: "article",
    publishedTime: "2024-10-03",
  },
  twitter: {
    card: "summary",
    title: "Data Cloud Identity Resolution: Practical Guardrails",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/data-cloud-identity-resolution-practical-guardrails.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-10-03</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Implement effective identity resolution in Data Cloud with practical guardrails and best practices for data quality and privacy.
          </p>
        </header>
