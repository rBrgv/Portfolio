...
export const metadata: Metadata = {
  ...
  description: "Scale multi-brand retail marketing across regions while maintaining brand consistency and operational efficiency.",
  keywords: ["Multi-Brand", "Retail", "Scaling", "Regional", "Consistency"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/multi-brand-retail-journeys-scaling-across-regions-without-breaking.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-03-21</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Scale multi-brand retail marketing across regions while maintaining brand consistency and operational efficiency.
          </p>
        </header>
