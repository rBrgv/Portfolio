...
export const metadata: Metadata = {
  ...
  description: "Implement effective segment hygiene practices in Data Cloud to prevent duplicate data and maintain data quality.",
  keywords: ["Data Quality", "Segment Hygiene", "Data Cloud", "Deduplication", "Best Practices"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Segment Hygiene in Data Cloud: Stop the Dupes Before They Spread",
    description: "Implement effective segment hygiene practices in Data Cloud to prevent duplicate data and maintain data quality.",
    type: "article",
    publishedTime: "2024-02-22",
  },
  twitter: {
    card: "summary",
    title: "Segment Hygiene in Data Cloud: Stop the Dupes Before They Spread",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/segment-hygiene-in-data-cloud-stop-the-dupes-before-they-spread.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-02-22</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Implement effective segment hygiene practices in Data Cloud to prevent duplicate data and maintain data quality.
          </p>
        </header>
