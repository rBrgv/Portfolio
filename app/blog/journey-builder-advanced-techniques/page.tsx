...
export const metadata: Metadata = {
  ...
  description: "Master advanced Journey Builder techniques to create sophisticated, personalized customer journeys that drive engagement and conversion.",
  keywords: ["Journey Builder", "Advanced Techniques", "Personalization", "Automation", "Marketing Cloud"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Journey Builder Advanced Techniques",
    description: "Master advanced Journey Builder techniques to create sophisticated, personalized customer journeys that drive engagement and conversion.",
    type: "article",
    publishedTime: "2024-05-30",
  },
  twitter: {
    card: "summary",
    title: "Journey Builder Advanced Techniques",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/journey-builder-advanced-techniques.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-05-30</span>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-ink dark:text-white mb-6 leading-tight">
            Journey Builder Advanced Techniques
          </h1>
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Master advanced Journey Builder techniques to create sophisticated, personalized customer journeys that drive engagement and conversion.
          </p>
        </header>
