...
export const metadata: Metadata = {
  ...
  description: "Start the new year with these 5 quick wins that will improve your Marketing Cloud performance and efficiency.",
  keywords: ["Marketing Cloud", "Audit", "Optimization", "Quick Wins", "Performance"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/marketing-cloud-audit-5-quick-wins-for-the-new-year.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-11-20</span>
            <span className="text-muted dark:text-gray-400 text-sm">5 min read</span>
          </div>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Start the new year with these 5 quick wins that will improve your Marketing Cloud performance and efficiency.
          </p>
        </header>
