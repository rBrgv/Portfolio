...
export const metadata: Metadata = {
  ...
  description: "Learn how to implement Data Cloud with privacy and compliance built-in from day one, avoiding costly mistakes and regulatory issues.",
  keywords: ["Data Cloud", "Compliance", "Privacy", "GDPR", "CCPA", "Data Governance"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/designing-a-compliance-aware-data-cloud-rollout.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-12-18</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Learn how to implement Data Cloud with privacy and compliance built-in from day one, avoiding costly mistakes and regulatory issues.
          </p>
        </header>
