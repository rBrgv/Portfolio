...
export const metadata: Metadata = {
  ...
  description: "Plan and execute successful multi-region Marketing Cloud deployments that meet global compliance and performance requirements.",
  keywords: ["Multi-Region", "Global Deployment", "Marketing Cloud", "Compliance", "Performance"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "How to Plan Multi-Region Marketing Cloud Deployments",
    description: "Plan and execute successful multi-region Marketing Cloud deployments that meet global compliance and performance requirements.",
    type: "article",
    publishedTime: "2024-06-13",
  },
  twitter: {
    card: "summary",
    title: "How to Plan Multi-Region Marketing Cloud Deployments",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/how-to-plan-multi-region-marketing-cloud-deployments.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-06-13</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Plan and execute successful multi-region Marketing Cloud deployments that meet global compliance and performance requirements.
          </p>
        </header>
