...
export const metadata: Metadata = {
  ...
  description: "Start your Data Cloud journey with these three lightweight use cases that deliver quick wins and prove value to stakeholders.",
  keywords: ["Data Cloud", "Use Cases", "Quick Wins", "Value", "Implementation"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/3-lightweight-data-cloud-use-cases-to-prove-early-value.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-12-10</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Start your Data Cloud journey with these three lightweight use cases that deliver quick wins and prove value to stakeholders.
          </p>
        </header>
