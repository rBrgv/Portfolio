...
export const metadata: Metadata = {
  ...
  description: "Learn how to implement proper attribution models in Marketing Cloud to accurately measure campaign performance and ROI.",
  keywords: ["Attribution", "Analytics", "ROI", "Measurement", "Marketing Cloud"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/attribution-guardrails-moving-beyond-last-click.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-11-28</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Learn how to implement proper attribution models in Marketing Cloud to accurately measure campaign performance and ROI.
          </p>
        </header>
