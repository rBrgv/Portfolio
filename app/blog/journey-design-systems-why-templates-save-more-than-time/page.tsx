...
export const metadata: Metadata = {
  ...
  description: "Build scalable journey design systems with templates that save time, ensure consistency, and improve team productivity.",
  keywords: ["Design Systems", "Templates", "Journey Builder", "Productivity", "Consistency"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "Journey Design Systems: Why Templates Save More Than Time",
    description: "Build scalable journey design systems with templates that save time, ensure consistency, and improve team productivity.",
    type: "article",
    publishedTime: "2024-05-16",
  },
  twitter: {
    card: "summary",
    title: "Journey Design Systems: Why Templates Save More Than Time",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/journey-design-systems-why-templates-save-more-than-time.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-05-16</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Build scalable journey design systems with templates that save time, ensure consistency, and improve team productivity.
          </p>
        </header>
