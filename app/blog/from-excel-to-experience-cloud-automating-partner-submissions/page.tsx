...
export const metadata: Metadata = {
  ...
  description: "Transform manual Excel-based partner submission processes into automated Experience Cloud workflows that save time and reduce errors.",
  keywords: ["Experience Cloud", "Automation", "Excel", "Workflow", "Efficiency"],
  authors: [{ name: "Bhargav Ramesh" }],
  openGraph: {
    title: "From Excel to Experience Cloud: Automating Partner Submissions",
    description: "Transform manual Excel-based partner submission processes into automated Experience Cloud workflows that save time and reduce errors.",
    type: "article",
    publishedTime: "2024-08-08",
  },
  twitter: {
    card: "summary",
    title: "From Excel to Experience Cloud: Automating Partner Submissions",
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/from-excel-to-experience-cloud-automating-partner-submissions.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-08-08</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Transform manual Excel-based partner submission processes into automated Experience Cloud workflows that save time and reduce errors.
          </p>
        </header>
