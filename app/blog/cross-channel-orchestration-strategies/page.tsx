...
export const metadata: Metadata = {
  ...
  description: "Master cross-channel marketing orchestration with Marketing Cloud to deliver consistent, personalized experiences across all touchpoints.",
  keywords: ["Cross-Channel", "Orchestration", "Personalization", "Marketing Cloud", "Strategy"],
...
export default function BlogPost() {
  const mdxPath = path.join(process.cwd(), 'app/blog/cross-channel-orchestration-strategies.mdx');
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="mb-12">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <span className="text-muted dark:text-gray-400 text-sm">2024-10-17</span>
          ...
          <p className="text-xl text-muted dark:text-gray-300 leading-relaxed">
            Master cross-channel marketing orchestration with Marketing Cloud to deliver consistent, personalized experiences across all touchpoints.
          </p>
        </header>
